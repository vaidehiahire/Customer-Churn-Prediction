...
Loaded and explored the dataset to understand patterns and class imbalance

Cleaned data by handling missing values and correcting data types
...
Used probability-based threshold tuning (0.35) to improve churn recall
